...
if [ `uname` == "Darwin" ];
then
  export DYLD_LIBRARY_PATH="C:/Program Files (x86)/libfreenect/lib/fakenect/:${LD_LIBRARY_PATH}"
else
  export LD_LIBRARY_PATH="C:/Program Files (x86)/libfreenect/lib/fakenect/:${LD_LIBRARY_PATH}"
fi
